...
public class RefactoringSequence {
	...
	// Constructor used to store information for priority objective.用于存储优先级目标信息的构造函数。
	public RefactoringSequence(ArrayList<Integer> refactorings, ArrayList<Integer> positions, ArrayList<String> names, 
	...
	// Constructor used to store information for diversity objective.用于存储分集目标信息的构造函数。
	public RefactoringSequence(ArrayList<Integer> refactorings, ArrayList<Integer> positions, ArrayList<String> names, 
	...
	// Constructor used to store information for both the priority and diversity objectives.用于存储优先级和多样性目标的信息的构造函数
	public RefactoringSequence(ArrayList<Integer> refactorings, ArrayList<Integer> positions, ArrayList<String> names, 
